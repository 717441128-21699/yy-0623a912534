...
export const appointmentList: Appointment[] = [
  ...
  { id: 'A003', patientId: 'P005', room: 'injection', projectName: '水光针', bodyPart: '面颊', estimatedDuration: 30, scheduledTime: '09:00', status: 'completed' },
  ...
  { id: 'A007', patientId: 'P006', room: 'photoelectric', projectName: '热玛吉', bodyPart: '下颌线', estimatedDuration: 90, scheduledTime: '10:00', status: 'in_progress' },
  ...
  { id: 'A010', patientId: 'P009', room: 'skin_treatment', projectName: '果酸焕肤', bodyPart: '全脸', estimatedDuration: 40, scheduledTime: '11:00', status: 'completed' },
  { id: 'A011', patientId: 'P010', room: 'injection', projectName: '玻尿酸填充', bodyPart: '法令纹', estimatedDuration: 45, scheduledTime: '11:00', status: 'waiting' },
